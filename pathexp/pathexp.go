...
// func (re *Pathex) execute_back(s string) (matched bool, data [][2]string) {
// 	if s == "" {
// 		return false, nil
// 	}

// 	//fmt.Printf("execute\n%s\n%s\n", re.Pattern, s)
// 	chars, pattern := s, re.Pattern

// 	charLen, patternLen := len(chars), len(pattern)
// 	var values [][2]string = make([][2]string, 0, len(re.SubNames))

// 	//fmt.Println(pattern, "length", patternLen)
// 	//fmt.Println(chars, "length", charLen)
